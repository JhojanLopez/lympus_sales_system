...
var app = {
    table: null,
    init: function () {
        app.initDatatable('#listaProductos'); /*INICIALIZA LA DATATABLE*/
    },
    initDatatable: function (id) {/*obtenemos el id de la tabla y la inicializamos*/
...
//                },
    ...
    setDataModalEditar(data) {
        ...
        $('#codigoEliminar').val(data.codigo);
    }
};
